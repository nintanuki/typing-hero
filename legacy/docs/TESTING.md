...
* Game active successful, theme music plays, volume, pause and full screen still work
* Player can fire lasers
* No crashing on use of powerups or other triggers (enemy down, get upgrade, damage, heal, etc)
* Leaderboard and initials display on player death, game over music works
