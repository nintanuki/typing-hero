...
* Player ship sprite can still move and shoot lasers briefly after death? (does this still happen?)
...
* Explosions sometimes don't trigger from touching an enemy with the shield
* Add floating scores
...
* Add random scrolling backgrounds (planet zone, nebula, etc) with parallax?
